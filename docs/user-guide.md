...
phone, where the list is a stack of cards rather than a table, that same **Select all
on this page** checkbox sits on its own line just above the first card. Once
