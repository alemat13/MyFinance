...
- **Delete protection**: deleting an account/category with existing transactions returns 409; deleting a category with existing subcategories returns 409; deleting a user who still owns an account returns 409.
